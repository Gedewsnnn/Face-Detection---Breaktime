...
* **🖥️ Overlay UI Intuitif:** Semua informasi yang Anda butuhkan (status saat ini, timer) ditampilkan dengan elegan sebagai *overlay* di jendela video Anda. Tidak perlu berganti-ganti aplikasi.
